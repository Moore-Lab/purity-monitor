...
for i in range(num_wvf):
    # print(i)
    cd1,cd2=acquire_file(rp_s, decimation, buffer_size, trg_delay, trig_channel, num_traces=1, dec_fac=decimation, trig_lev_mv=500)
    # print(cd2[0])
...
f = h5py.File("CSP_test_500mV.h5", "w")
